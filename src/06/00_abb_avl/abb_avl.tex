...
\begin{frame}{Guardar um conjunto de chaves}
  ...
  \begin{center}
    \begin{tabular}{lll}
      \toprule
      \textbf{Estrutura} & \textbf{Inserção} & \textbf{Busca (pior caso)} \\
      \midrule
...
\begin{frame}[fragile]{Remoção: achar o nó}
\begin{minted}{go}
func Remove(a *No, v int) *No {
	...
	// daqui em diante: a.Info == v, o nó a remover é este
\end{minted}

  \vspace{0.2cm}
  A descida é a mesma da busca. Cada chamada devolve a subárvore já corrigida, e
  o pai a reatribui em \texttt{a.Esq} ou \texttt{a.Dir}. Quem chama de fora
  escreve \texttt{a = Remove(a, v)}.
\end{frame}

\begin{frame}[fragile]{Remoção: os três casos}
\begin{minted}[fontsize=\scriptsize]{go}
	// continuação de Remove, com a.Info == v
  ...
  \begin{columns}
    \begin{column}{0.56\textwidth}
      ...
      \begin{tikzpicture}[-, level distance=0.85cm,
        ...
        \node [arn_b, label=right:{\scriptsize fb $+2$}] {50}
        child { node [arn_b, label=left:{\scriptsize fb $-1$}] {30}
            child { node [arn_b] {20}
                child { node [arn_b] {10} }
                child [missing]
              }
    ...
    \begin{column}{0.44\textwidth}
      \begin{block}{}
        A árvore de exemplo era AVL. Inserimos o 37 como folha, e ela deixou de
        ser.
        ...
        \vspace{0.2cm}
        Qual dos quatro casos ocorre?
      \end{block}
    \end{column}
  \end{columns}
\end{frame}

\begin{frame}{O 37: rotação dupla na raiz}
  \begin{columns}[t]
    \begin{column}{0.33\textwidth}
      \centering
      {\scriptsize depois de inserir o 37}

      \vspace{0.1cm}
      \begin{tikzpicture}[-, level distance=1.25cm, scale=0.58,
          every node/.style={transform shape},
          level 1/.style={sibling distance=3.1cm},
          level 2/.style={sibling distance=1.8cm},
          level 3/.style={sibling distance=1.2cm},
          level 4/.style={sibling distance=1.2cm}]
        \node [arn_b, label=above right:{\scriptsize fb $+2$}] {50}
        child { node [arn_d] {30}
            child { node [arn_b] {20}
                child { node [arn_b] {10} }
                child [missing]
    ...
    \begin{column}{0.33\textwidth}
      \centering
      {\scriptsize rotação à esquerda no 30}
      ...
      \begin{tikzpicture}[-, level distance=1.25cm, scale=0.58,
          ...
          level 3/.style={sibling distance=1.2cm},
          level 4/.style={sibling distance=1.2cm}]
        \node [arn_d, label=above right:{\scriptsize fb $+2$}] {50}
        child { node [arn_d] {40}
            child { node [arn_b] {30}
                child { node [arn_b] {20}
                    child { node [arn_b] {10} }
    ...
    \begin{column}{0.33\textwidth}
      \centering
      {\scriptsize rotação à direita no 50}
      ...
      \begin{tikzpicture}[-, level distance=1.25cm, scale=0.58,
          ...
          level 2/.style={sibling distance=1.8cm},
          level 3/.style={sibling distance=1.2cm}]
        \node [arn_d, label=above right:{\scriptsize fb $0$}] {40}
        child { node [arn_b] {30}
            child { node [arn_b] {20}
                child { node [arn_b] {10} }
                child [missing]
  ...
  \vspace{0.2cm}
  \centering
  Raiz com fb $+2$ e filho pesado com fb $-1$: caso esquerda-direita.

  \vspace{0.1cm}
  {\scriptsize A árvore volta à altura 3, e o in-ordem continua
  \texttt{10 20 30 35 37 40 45 50 90 95}.}
\end{frame}
