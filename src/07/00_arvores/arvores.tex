...
\begin{frame}[t]
  ...
  \begin{figure}[h]
    \centering
    \only<1>{\includegraphics[width=.5\textwidth]{img/pseudo_tree.png}}
    \only<2>{\includegraphics[width=.5\textwidth]{img/pseudo_tree2.png}}
    \only<3>{\includegraphics[width=.5\textwidth]{img/pseudo_tree3.png}}
  \end{figure}
\end{frame}
...
\begin{frame}[c]
  \frametitle{Exemplo: Construção de árvore}
...
\begin{frame}[fragile]
  \frametitle{Construção de árvore}
