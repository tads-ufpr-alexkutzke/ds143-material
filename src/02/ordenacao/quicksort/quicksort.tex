...
\begin{frame}[t]
  ...
  \begin{itemize}
    ...
    \item Varrer \tcb{j} da direita para a esquerda enquanto $a[j] > a[lo]$;
...
\begin{frame}[fragile]
  ...
  \begin{description}
    \item[Caso médio] Número de comparações para um array de $n$ chaves \textbf{distintas} é $~ 1.39 n \log_{2}{n}$ (e o número de trocas é $~\frac{1}{3}{n}\log_{2}{n}$):
  \end{description}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Utilizar a mediana exata do array (caro);
