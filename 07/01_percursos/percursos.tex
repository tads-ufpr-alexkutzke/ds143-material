...
\begin{frame}
  \frametitle{Ávores cheias: número de nós}

    \only<1>{\center Uma árvore \textit{binária} \tcb{cheia (ou completa)} é aquela em que todos os nós internos têm duas subárvores e todos os nós folhas estão no último nível. uma árvore com um único nó é 0.}
...
\begin{frame}
  ...
  \texttt{int altura\_arvores(Arvore *a);}
