...
A defesa será realizada por meio de execução e explicação do código pela equipe durante
o horário de aula. A defesa **não** é feita para a turma toda, mas sim, apenas para o professor.
